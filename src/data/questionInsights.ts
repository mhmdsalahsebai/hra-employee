...
const questionInsights: Record<string, QuestionInsight> = {
  ...
  SedentaryWork: {
    kind: "tip",
    text: "الجلوس الطويل عامل خطر مستقل حتى لو كنت تتمرّن؛ قِف وتحرّك 3–5 دقائق كل ساعة.",
  },
  VigorousActivityDays: {
    kind: "tip",
    text: "توصي منظمة الصحة العالمية بـ 75 دقيقة على الأقل من النشاط العالي الشدة أسبوعيًا لصحة القلب.",
  },
  ModerateActivityDays: {
    kind: "tip",
    text: "150 دقيقة نشاط متوسط أسبوعيًا (نحو 21 دقيقة يوميًا) هدف واقعي يحمي قلبك ووزنك.",
  },
  ...
  WalkingDays: {
    kind: "encouragement",
    text: "المشي 30 دقيقة معظم أيام الأسبوع يقلّل خطر أمراض القلب بشكل ملموس؛ كل خطوة تُحتسب.",
  },
  SittingHours: {
    kind: "tip",
  ...
  SleepDuration: {
    kind: "tip",
    text: "يحتاج البالغ 7–9 ساعات نوم؛ النوم الكافي يقوّي المناعة والمزاج والتركيز والذاكرة.",
  },
  FruitVegetableIntake: {
    kind: "tip",
    text: "5 حصص من الخضار والفاكهة يوميًا هدف بسيط يصنع فرقًا كبيرًا في طاقتك ووقايتك.",
  },
  TobaccoUse: {
    kind: "tip",
    text: "تبدأ فائدة الإقلاع عن التبغ خلال 20 دقيقة، وخلال عام ينخفض خطر أمراض القلب إلى النصف تقريبًا.",
  },
  FastFoodFrequency: {
    kind: "tip",
  ...
  WaterIntake: {
    kind: "tip",
    text: "شرب 6–8 أكواب ماء يوميًا يدعم التركيز والطاقة وصحة الكلى؛ ابدأ يومك بكوب.",
  },
  HighSaltFoodPreference: {
    kind: "tip",
    text: "تقليل الملح إلى أقل من 5 غرام يوميًا (نحو ملعقة صغيرة) يخفض ضغط الدم ويحمي قلبك.",
  },
  FitnessLevel: {
    kind: "encouragement",
  ...
  EmergencyFund: {
    kind: "tip",
    text: "صندوق طوارئ يغطّي 3–6 أشهر من نفقاتك هو أقوى درع مالي ضد مفاجآت الحياة.",
  },
