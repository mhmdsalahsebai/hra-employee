...
export const programs: Program[] = [
  {
    ...
    sessions: [
      { order: 1, title: "تقييم الوضع ووضع الهدف", focus: "قراءة مؤشر كتلة الجسم ومحيط الخصر، وتحديد هدف واقعي لخسارة ٥٪ خلال ٣ أشهر.", durationMin: 45 },
  ...
  },
  {
    ...
    tagline: "من الخمول إلى ١٥٠ دقيقة نشاط أسبوعيًا بخطوات صغيرة",
    description:
    ...
    sessions: [
      ...
      { order: 3, title: "بناء التحمّل", focus: "خطة مشي/كارديو متدرّجة نحو ١٥٠ دقيقة أسبوعيًا.", durationMin: 40 },
  ...
  },
  {
    ...
    sessions: [
      ...
      { order: 3, title: "صندوق الطوارئ", focus: "بناء وسادة مالية تلقائية تغطي نفقات ٣ أشهر تدريجيًا.", durationMin: 40 },
      { order: 4, title: "معالجة الديون", focus: "ترتيب سداد الديون وتخفيف عبئها على الميزانية الشهرية.", durationMin: 40 },
      { order: 5, title: "التخطيط للمستقبل", focus: "أهداف طويلة الأجل وبداية ادخار التقاعد ولو ٥٪ شهريًا.", durationMin: 40 },
    ],
